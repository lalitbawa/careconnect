...
export const metadata: Metadata = {
  title: "Caregiver Blog | CareConnect AI",
  description: "Expert insights on eldercare, wearable health monitoring, and caring for elderly loved ones. Tips for remote caregivers and family carers in the UK.",
  openGraph: {
